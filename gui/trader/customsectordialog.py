...
_WelcomeMessage = """
    ...
    custom sector. These posters are used by {name} to rewrite the tiles
    generated by Traveller map, overlaying your custom sectors to allow them to
    be displayed (almost) seamlessly in the Traveller Map windows displayed in
    the app.</p>
