...
_WelcomeMessage = """
    ...
    them to be displayed (almost) seamlessly in the Traveller Map windows displayed in the app.</p>
    <p>There are a few important things to note about this feature:
    <ul style="margin-left:15px; -qt-list-indent:0;">
    <li>The posters of your custom sectors will be generated at the point you add the sector. This means
    the display options (render style, filled borders, sector grid etc) are fixed at the point you add
    the sector. If you change the display options in the Traveller Map windows displayed in the app,
    custom sectors will not reflect the change.</li>
...
class _NewSectorDialog(gui.DialogEx):
    ...
    def _setupRenderOptionControls(self) -> None:
        ...
        supportedStyles = [style for style in travellermap.Style if style is not travellermap.Style.Candy]
