...
RefuellingStrategyToolTip = createStringToolTip(
    ...
    'unrefined fuel, but also refuel at star ports that only have refined fuel '
    'if it results in a more optimal jump route.</li>'
    '<li><b>Gas Giant Preferred</b> - Ideally refuel by skimming gas giants, '
    'but also refuel at star ports if it results in a more optimal jump route. '
    'If refuelling at a star port with refined and unrefined fuel, unrefined '
    'fuel costs will be used for logistics calculations.</li>'
    '<li><b>Water Preferred</b> - Ideally refuel by extracting hydrogen from '
    'water or ice, but also refuel at star ports if it results in a more '
    ...
    'or extracting hydrogen from water or ice, but also refuel at star ports '
    'if it results in a more optimal jump route. If refuelling at a star port '
    'with refined and unrefined fuel, unrefined fuel costs will be used for '
