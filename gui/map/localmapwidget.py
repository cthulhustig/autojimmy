...
# - Need to check that custom sector mains are being generated when local rendering is
#   configured. It's possible they were being generated by the proxy process
# TODO: Qrekrsha zone overlay
# TODO: Antares Supernova overlay
...
class _EmpressWaveOverlay(_MapOverlay):
    ...
    def draw(
        ...
        radius = (year - (1281 + (45 - 1) / 365)) * vel - y
        if radius < 0:
            return
