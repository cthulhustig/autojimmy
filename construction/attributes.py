...
class ConstructionAttribute(enum.Enum):
    pass
...
class AttributeInterface(object):
    ...
    def id(self) -> ConstructionAttribute:
...
class FlagAttribute(AttributeInterface):
    def __init__(
            self,
            attributeId: ConstructionAttribute
            ) -> None:
        super().__init__()
...
class AttributesGroup(object):
    def __init__(self) -> None:
        self._attributes: typing.Dict[ConstructionAttribute, AttributeInterface] = {}
    ...
    def attribute(
        ...
        assert(isinstance(attributeId, ConstructionAttribute))
