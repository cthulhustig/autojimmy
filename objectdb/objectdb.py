...
class ObjectDbManager(object):
    ...
    def _updateEntity(
            ...
            entity: DatabaseEntity,
            cursor: sqlite3.Cursor,
            alreadyUpdated: typing.Optional[typing.Set[str]] = None
            ) -> None:
        if alreadyUpdated == None:
            alreadyUpdated = set()
        elif entity.id() in alreadyUpdated:
            # The entity has already been updated so no point updating it again.
            # This can happen if the there are multiple references to the entity
            # in the hierarchy being updated
            return
        alreadyUpdated.add(entity.id())
