...
class World(astronomer.Entity):
    def __init__(
        ...
        common.validateObject(name='hex', value=hex, objectType=astronomer.HexPosition)
        common.validateStr(name='name', value=name, allowEmpty=False)
        common.validateBool(name='isNameGenerated', value=isNameGenerated)
        common.validateObject(name='allegiance', value=allegiance, objectType=astronomer.Allegiance, allowNone=True)
        common.validateObject(name='zone', value=zone, objectType=astronomer.ZoneType, allowNone=True)
        common.validateObject(name='uwp', value=uwp, objectType=astronomer.UWP, allowNone=True)
        common.validateObject(name='economics', value=economics, objectType=astronomer.Economics, allowNone=True)
        common.validateObject(name='culture', value=culture, objectType=astronomer.Culture, allowNone=True)
        common.validateObject(name='nobilities', value=nobilities, objectType=astronomer.Nobilities, allowNone=True)
        common.validateObject(name='bases', value=bases, objectType=astronomer.Bases, allowNone=True)
        common.validateInt(name='systemWorlds', value=systemWorlds, allowNone=True, min=0)
        common.validateObject(name='pbg', value=pbg, objectType=astronomer.PBG, allowNone=True)
        common.validateObject(name='stellar', value=stellar, objectType=astronomer.Stellar, allowNone=True)
        common.validateCollection(name='tradeCodes', value=tradeCodes, elementType=traveller.TradeCode, allowNone=True)
        common.validateCollection(name='sophontPopulations', value=sophontPopulations, elementType=astronomer.SophontPopulation, allowNone=True)
        common.validateCollection(name='rulingAllegiances', value=rulingAllegiances, elementType=astronomer.Allegiance, allowNone=True)
        common.validateCollection(name='owningWorldRefs', value=owningWorldRefs, elementType=WorldReference, allowNone=True)
        common.validateCollection(name='colonyWorldRefs', value=colonyWorldRefs, elementType=WorldReference, allowNone=True)
